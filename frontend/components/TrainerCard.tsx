...
export default function TrainerCard({ trainer }: TrainerCardProps) {
  return (
    <Link href={`/profile/trainer?id=${trainer.id}`}>
      <div className="border rounded-lg shadow-md bg-[#192024] w-80 flex flex-col items-center text-center pb-4 transform transition-transform duration-300 hover:scale-105 hover:shadow-lg cursor-pointer">
        ...
        <div className="text-gray-400 text-sm mb-4">
          ...
          {trainer.skills?.length ? trainer.skills.join(", ") : "No skills provided"}
        </div>*/}
