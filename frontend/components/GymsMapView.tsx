        ...
        marker.addListener('click', () => {
          const content = `
            <div style="max-width: 250px; color: #000;">
              ...
              ${gymData.gym.profile_img 
                ? `<a href="/dashboard/user/gym/${gymData.gym.gym_id}" >
                    <img src="${gymData.gym.profile_img}" 
                    alt="${gymData.gym.gym_name || 'Gym'}" 
                    style="width: 100%; height: 120px; object-fit: cover; border-radius: 4px; margin-bottom: 8px; cursor: pointer;">
                    </a>`
                : ''
              }
