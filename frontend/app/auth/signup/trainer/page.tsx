...
export default function TrainerSignup() {
  ...
  const addDocumentEntry = () => {
    ...
    setDocuments([
      ...documents,
      { id: newId, type: "", file: null, uploaded: false },
    ]);
  };
  ...
  const uploadToCloudinary = async (file: File): Promise<string> => {
    ...
    if (
      ...
      uploadPreset === "YOUR_ACTUAL_PRESET_NAME"
    ) {
      throw new Error(
        "Cloudinary upload preset is not configured properly. Please check your .env file and Cloudinary dashboard."
      );
    }
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const phoneNo = formData.get("contactNo") as string;
      ...
      toast({
        ...
        description:
          "Your trainer registration has been submitted successfully. Redirecting to login...",
      });
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-400">
                        This will be displayed on your trainer profile to help
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      <p className="text-xs text-gray-400">
                        List your training specializations, certifications, and
                        areas of expertise
                      </p>
                    </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-blue-900/20 border border-blue-800 rounded-lg p-4 mb-4">
                      <p className="text-sm text-blue-300">
                        <strong>Required Documents:</strong> Fitness
                        certification, CPR certification, professional license
                        (if applicable), and any specialized training
                        certificates.
                      </p>
                    </div>
                  ...
                  <div className="space-y-4 p-4 bg-gray-800/30 rounded-lg border border-gray-700">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <Label
                        ...
                        className="text-sm text-gray-300 leading-relaxed"
                      >
                        I understand that my account will be reviewed and
